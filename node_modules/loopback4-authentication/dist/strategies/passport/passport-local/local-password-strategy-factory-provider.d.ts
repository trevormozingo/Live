...
export interface LocalPasswordStrategyFactory {
    (options?: PassportLocal.IStrategyOptions | PassportLocal.IStrategyOptionsWithRequest): PassportLocal.Strategy;
}
export declare class LocalPasswordStrategyFactoryProvider implements Provider<LocalPasswordStrategyFactory> {
    ...
    getLocalStrategyVerifier(options?: PassportLocal.IStrategyOptions | PassportLocal.IStrategyOptionsWithRequest): PassportLocal.Strategy;
}

    ...
    constructor() {
        this.providers = {
            ...
            [keys_2.Strategies.Passport.GOOGLE_OAUTH2_STRATEGY_FACTORY
                .key]: strategies_1.GoogleAuthStrategyFactoryProvider,
            [keys_2.Strategies.Passport.AZURE_AD_STRATEGY_FACTORY
                .key]: strategies_1.AzureADAuthStrategyFactoryProvider,
            [keys_2.Strategies.Passport.KEYCLOAK_STRATEGY_FACTORY
                .key]: strategies_1.KeycloakStrategyFactoryProvider,
            // Verifier functions
            ...
            [keys_2.Strategies.Passport.GOOGLE_OAUTH2_VERIFIER
                .key]: strategies_1.GoogleAuthVerifyProvider,
